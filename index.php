...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-navajo white bg-danger">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html"style="color: #ffff">Ahmad Fauzan UKK</a>
        <!-- Sidebar Toggle-->
        <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
    </nav>
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-gainsboro bg-danger" id="sidenavAccordion">
